...
authenticateRouter.post('/event', eventImageUpload.single('cover'), [
    ...
    const organizerEventParams = [name, slug, description, category_id, cover, scheduled_at, ticket_price, about, story, venue_id, features_id, 1, req.headers['user-agent'], req.ip, HelperFunction_1.default.getDateTime(0), HelperFunction_1.default.getDateTime(0)];
